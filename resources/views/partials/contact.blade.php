...
<section class="bg-white pt-8 pb-20 lg:py-[120px] overflow-hidden relative z-10">
    <div class="container">
       <div class="flex flex-wrap lg:justify-between -mx-4">
          <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
             <div class="items-center max-w-[570px] mb-12 lg:mb-0">
                <span class="block mb-4 text-base text-indigo-600 font-semibold">
                Contact Us
                </span>
                <h2
                   class="
                ...
                <div class="flex mb-8 max-w-[370px] w-full">
                 ...
                 <div class="flex mb-8 max-w-[370px] w-full">
                    ...
                    <div class="w-full">
                       ...
                       <p class="text-base text-body-color">(+233)24 694 0308</p>
                    </div>
                 </div>
                 <div class="flex mb-8 max-w-[370px] w-full">
                    <div
                    ...
                    <div class="w-full">
                       ...
                       <p class="text-base text-body-color">qsl.nkonta@gmail.com</p>
                    </div>
                 </div>
                <div>
