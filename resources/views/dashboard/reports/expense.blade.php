<x-app-layout>
    ...
    <div class="bg-white p-4 mb-3">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center" id="">
            {{   Str::upper(Auth::user()->company_name) }} EXPENSE REPORT
        </h2>
            ...
            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
              ...
              <table class="min-w-full" id="expenses">
                  <thead class="bg-white border-b border-gray-300">
                      <tr>
                      <th scope="col" class="text-sm font-bold text-gray-900 px-3 py-2 text-left">
                          REF_NO
                      </th>
                      <th scope="col" class="text-sm font-bold text-gray-900 px-3 py-2 text-left">
                         CODE
                      ...
                      <th scope="col" class="text-sm font-bold text-gray-900 px-3 py-2 text-right">
                          AMOUNT (GHS)
                      </th>
                      </tr>
                  </thead>
                  <tbody>
                      ...
                      <td class="px-3 py-1 whitespace-nowrap text-sm font-medium text-gray-900 text-right">
                      ...
                      <tr class="bg-white border-b">
                          ...
                          <td class="px-3 py-1 whitespace-nowrap text-sm font-bold text-gray-900">
                              Total
                      </td>
